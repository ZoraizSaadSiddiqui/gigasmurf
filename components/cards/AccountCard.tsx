  ...
  return (
    <article className="card overflow-hidden" style={cardStyle}>
      ...
      <div className="card-body d-flex flex-column" style={{ boxSizing: 'border-box', width: '100%', height: '207px', flex: '0 0 207px', padding: '16px 12px', color: '#fff' }}>
        ...
        <footer className="d-flex align-items-center justify-content-between" style={{ marginTop: 'auto', padding: 0 }}><div className="d-flex flex-column" style={{ gap: '2px' }}><span style={{ color: '#cfc2d6', fontFamily: "'Manrope', sans-serif", fontSize: '14px', fontWeight: 400, lineHeight: '14px' }}>Price</span><strong style={{ color: '#fff', fontFamily: "'Manrope', sans-serif", fontSize: '24px', fontWeight: 800, lineHeight: '32px' }}>{acc.price}</strong></div><button type="button" className="btn account-buy-button rounded-pill d-flex align-items-center" style={{ boxSizing: 'border-box', minWidth: '101px', height: '48px', padding: '14px 24px', gap: '8px', border: '2px solid #a023ec', background: 'transparent', color: '#a023ec', fontFamily: "'Manrope', sans-serif", fontSize: '18px', fontWeight: 700, lineHeight: '18px', whiteSpace: 'nowrap' }}>Buy <svg style={{ width: '12px', height: '24px', flex: '0 0 12px' }} aria-hidden="true" viewBox="0 0 12 24" fill="none"><path d="m3 6 6 6-6 6" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" /></svg></button></footer>
      </div>
    </article>
  );
}
