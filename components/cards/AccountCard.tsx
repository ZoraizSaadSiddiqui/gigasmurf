  ...
  return (
    <article data-account-card className="card overflow-hidden" style={cardStyle}>
      <div className="position-relative" style={{ width: '100%', height: '192px', flex: '0 0 192px', overflow: 'hidden', borderRadius: '12px', background: '#1c0c3e' }}>
        ...
        <span className="badge rounded-pill" style={{ position: 'absolute', zIndex: 1, top: '12px', left: '12px', padding: '4px 8px', border: '1px solid rgba(34, 197, 94, 0.2)', background: 'rgba(34, 197, 94, 0.12)', color: '#22c55e', fontSize: '9px', fontWeight: 500 }}>Promoted</span>
      ...
      <div className="card-body d-flex flex-column" style={{ boxSizing: 'border-box', width: '100%', height: '207px', flex: '0 0 207px', padding: '16px 12px', color: '#fff' }}>
        <h4 style={{ margin: '0 0 6px', color: '#fff', fontSize: '20px', fontWeight: 700, lineHeight: '22px' }}>{acc.name}</h4>
        <p style={{ minHeight: 0, margin: '0 0 12px', paddingBottom: '12px', borderBottom: '1px solid rgba(255, 255, 255, 0.15)', color: '#cfc2d6', fontSize: '14px', fontWeight: 400, lineHeight: '18px' }}>
          {acc.desc}
        ...
        <div className="d-flex align-items-center justify-content-between">
          <div className="d-flex align-items-center gap-2" style={{ color: '#fff', fontSize: '16px', fontWeight: 600, lineHeight: '20px' }}>
          ...
          <span style={{ color: '#fff', fontSize: '16px', fontWeight: 600, lineHeight: '20px' }}><span style={{ color: '#a023ec' }}>&#9733;</span> {acc.rating}</span>
        </div>
        <footer className="d-flex align-items-center justify-content-between" style={{ marginTop: 'auto', padding: 0 }}><div className="d-flex flex-column" style={{ gap: '2px' }}><span style={{ color: '#cfc2d6', fontSize: '14px', fontWeight: 400, lineHeight: '14px' }}>Price</span><strong style={{ color: '#fff', fontSize: '24px', fontWeight: 800, lineHeight: '32px' }}>{acc.price}</strong></div><button type="button" className="btn account-buy-button rounded-pill d-flex align-items-center" style={{ boxSizing: 'border-box', minWidth: '101px', height: '48px', padding: '14px 24px', gap: '8px', border: '2px solid #a023ec', background: 'transparent', color: '#a023ec', fontSize: '18px', fontWeight: 700, lineHeight: '18px', whiteSpace: 'nowrap' }}>Buy <svg style={{ width: '12px', height: '24px', flex: '0 0 12px' }} aria-hidden="true" viewBox="0 0 12 24" fill="none"><path d="m3 6 6 6-6 6" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" /></svg></button></footer>
      </div>
    </article>
  );
}
